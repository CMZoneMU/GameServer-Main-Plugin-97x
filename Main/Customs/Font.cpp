...
void CFont::Init()
{
	...
	// -- Kayito 97k 0x0041F012 0x0041F08C -> 0041E4D3, 0041E54D
	SetCompleteHook(0xE9, 0x0041E4D3, 0x0041E54D); // Skip Setting FontHeight

	//-- Kayito 97k 0x0041F0CD -> 0041E58E
	SetCompleteHook(0xE8, 0x0041E58E, &this->MyCreateFont);
	SetByte(0x0041E58E + 5, 0x90);

	//-- Kayito 97k 0x0041F10E -> 0041E5CF
	SetCompleteHook(0xE8, 0x0041E5CF, &this->MyCreateFontBold);
	SetByte(0x0041E5CF + 5, 0x90);

	//-- Kayito 97k 0x0041F151 -> 0041E612
	SetCompleteHook(0xE8, 0x0041E612, &this->MyCreateFontBig);
	SetByte(0x0041E612 + 5, 0x90);
}
